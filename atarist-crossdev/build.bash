...
if [ $# -lt 4 ]; then
    ...
    echo
    echo "  * release_suffix : "
    echo "      suffix added to 'atarist-crossdev' for naming the build ;"
    echo "      e.g. 'ubuntu'"
    echo "      e.g. 'debian'"
    echo
    echo "  * release_id : "
...
release_id="$4"
shift 4
tag_name="atarist-crossdev--${release_suffix}:${release_id}"

args="--build-arg BASE_IMAGE_NAME=${base_image_name} --build-arg BASE_IMAGE_VERSION=${base_image_version} -t ${tag_name}"
